...
public class State_Human_VS_Human extends GameState {

	public Board_Human_VS_Human board_Human_VS_Human;
	private boolean pause = false;

	public State_Human_VS_Human(GameStateManager gsm) {
		this.gsm = gsm;
	...
	public void init() {
		...
		board_Human_VS_Human = new Board_Human_VS_Human();
		board_Human_VS_Human.setNames(); //Initialises a new board and asks to set names.
	}
