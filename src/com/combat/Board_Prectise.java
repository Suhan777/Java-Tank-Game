...
public class Board_Prectise extends JPanel implements ActionListener, KeyListener {
	//Global variables initialised at the start, and used later
	private Timer timer;
	private Timer timer2;
	public Hero hero;
	public Hero_Target computer;
	Image image;
	Image speed;
	Image fire;
	Image shield;
	...
	private void init() {
		...
		loadPowerUpImages();//secImage is a class which contains all the different images, modeSelect defines which set tanks, bullets and walls you want
		...
		computer = new Hero_Target(50, 350, 0);
	...
	private void drawPowerupAI(Graphics g) {
		...
		case 0:
			...
			break;
		case 1:
			g.drawImage(speed, 0, 0, 50, 50, this); // speed = 4.5;
			// powerup = true;
			break;
		case 2:
			g.drawImage(nospeed, 0, 0, 50, 50, this);
			break;
		case 3:
			g.drawImage(fire, 0, 0, 75, 50, this);
			// powerup = true;
			break;
		case 4:
			g.drawImage(nofire, 0, 0, 75, 50, this);
			// fireRate = 1000;
			// powerup = true;
			break;
		case 5:
			g.drawImage(shield, 0, 0, 50, 50, this); // powerup = true;
			// life++;
			break;
		}
